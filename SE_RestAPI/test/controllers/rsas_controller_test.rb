...
class RsasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsa" do
    assert_difference('Rsa.count') do
      post rsas_url, params: { rsa: { d: @rsa.d, e: @rsa.e, enc_message: @rsa.enc_message, id: @rsa.id, message: @rsa.message, n: @rsa.n } }
    end
  ...
  test "should update rsa" do
    patch rsa_url(@rsa), params: { rsa: { d: @rsa.d, e: @rsa.e, enc_message: @rsa.enc_message, id: @rsa.id, message: @rsa.message, n: @rsa.n } }
